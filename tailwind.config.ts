    ...
    extend: {
      colors: {
        ...
        status: {
          ...
          "ordered-foreground": "hsl(var(--status-ordered-foreground))",
          ...
          "served-foreground": "hsl(var(--status-served-foreground))",
        ...
        pool: {
          DEFAULT: "hsl(var(--pool-accent))",
          foreground: "hsl(var(--pool-accent-foreground))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
